...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            ...
            return sprintf('%s per page', pageNumber); // changed by gev 25.11.2015
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            //return sprintf('Showing %s to %s of %s rows', pageFrom, pageTo, totalRows);
            return sprintf(''); // changed by gev 25.11.2015
        },
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        $.each(this.header.events, function (i, events) {
            ...
            // fix bug, if match_events is defined with namespace
    ...
    BootstrapTable.prototype.updateRowWithId = function (params) {
        if (!params.hasOwnProperty('field') || !params.hasOwnProperty('values') || !params.hasOwnProperty('index') || !params.hasOwnProperty('row')) {
            return;
        }
